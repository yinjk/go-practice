...
func init() {
	...
	flag.IntVar(&c, "c", 4, "the concurrency of service invocation for test")
...
func createKafkaProducer() sarama.AsyncProducer {
	...
	producer, err := sarama.NewAsyncProducer([]string{"172.21.108.130:9092","172.21.82.12:9092","172.21.82.13:9092"}, config)
	if err != nil {
		panic(err)
	}
	return producer
